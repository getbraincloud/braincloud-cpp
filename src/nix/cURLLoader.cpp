...
namespace BrainCloud
{
...
#endif
            // On Windows/Linux, no need to forcibly close socket anymore
        }
    }
    ...
    {
        return !_threadRunning.load(std::memory_order_acquire);
    }
    ...
    */
    ...
    void cURLLoader::loadThreadCurl(cURLLoader * loader)
    {
        ...
        //Safer version
        loader->_threadRunning.store(false, std::memory_order_release);
    }
